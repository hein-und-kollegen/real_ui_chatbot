  ...
  return (
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <IconQuestionMark className="bg-primary text-secondary size-[24px] cursor-pointer rounded-full p-0.5 opacity-60 hover:opacity-90 lg:size-[30px] lg:p-1" />
      </DropdownMenuTrigger>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem className="flex justify-between">
          <div>Dateiansicht ein-/ausschalten</div>
          <div className="flex opacity-60">
            <div className="min-w-[30px] rounded border-DEFAULT p-1 text-center">
              ⌘
            </div>
        ...
        <DropdownMenuItem className="flex justify-between">
          <div>Datenabruf ein-/ausschalten</div>
          <div className="flex opacity-60">
            <div className="min-w-[30px] rounded border-DEFAULT p-1 text-center">
              ⌘
            </div>
        ...
        <DropdownMenuItem className="flex justify-between">
        <div>Seitenleiste ein-/ausblenden</div>
        <div className="flex opacity-60">
            <div className="min-w-[30px] rounded border-DEFAULT p-1 text-center">
              ⌘
            </div>
