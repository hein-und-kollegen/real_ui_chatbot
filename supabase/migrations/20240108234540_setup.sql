...
AS $$
DECLARE
  project_url TEXT := 'https://fmcpfhlrmmuvkdspbpqa.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZtY3BmaGxybW11dmtkc3BicHFhIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcyNDIyNTUxNCwiZXhwIjoyMDM5ODAxNTE0fQ.9ll-GZ3Bvsu0okhTG95cH3SJV_REZzymHQ8M4gIEGC4'; -- full access needed for http request to storage
